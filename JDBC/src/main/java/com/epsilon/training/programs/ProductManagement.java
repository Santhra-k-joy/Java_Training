...
//				JDBCProductDao  am =new JDBCProductDao();
			...
			//	Product p = new Product();
				...
				p.setDiscount(Double.parseDouble(checkNull(Double. toString(p.getDiscount()),discount)));
				 ...
				 // System.out.println("Name: "+p.getName()+" Brand: "+p.getBrand()+" Category: "+p.getCategory()+ " Quantity: "+p.getQuantityPerUnit() + " Description: "+ p.getDescription() + " Picture: "+p.getPicture()+" Price: "+p.getUnitPrice()+" discount:  "+p.getDiscount());
